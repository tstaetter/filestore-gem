Gem::Specification.new do |s|
  ...
  s.files       = ["module.rb", "lib/filestore.rb", "lib/memory_meta.rb", "lib/log.rb", "lib/meta_manager.rb", "lib/multitenant_filestore.rb", "lib/observer.rb"]
  s.test_files	= ["test/classes.rb", "test/tc_meta.rb", "test/tc_module.rb", "test/tc_filestore.rb", "test/tc_multitenant.rb", "test/ts_all.rb"]
